<?php
/*
Plugin Name: Rapid Image Converter Plugin
Plugin URI: http://example.com
Description: A plugin that allows users to upload up to 10 images and convert them to various formats (PNG, JPG, GIF, BMP, TIFF, WEBP) using Imagick or GD.
Version: 1.0
Author: Your Name
...
function rapid_image_converter_shortcode() {
    ob_start();
    ?>
    ...
    <!-- Inline CSS for styling the converter -->
    <style>
...
add_shortcode('image_converter', 'rapid_image_converter_shortcode');
